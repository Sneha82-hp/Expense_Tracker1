...
// ✅ Helper: converts base64 string to Gemini-compatible input
export const createPartFromBase64 = (base64: string, mimeType: string) => ({
  inlineData: {
    data: base64,
    mimeType,
  },
...
// ✅ Helper: wraps the prompt + image into proper Gemini content
export const createUserContent = (parts: any[]) => ({
  role: "user",
  parts,
});
